...
extension Story {
    ...
    var text: String {
        ...
        case .Droid(let name):
            return "After a long walk slightly uphill, \(name), you end up at the top of a small crater. You look around and are overjoyed to see your robot friend, Droid-S1124. It had been lost on a previous mission to Mars. You take it back to your ship and fly back to Earth."
        case .Home:
...
struct Adventure {
    static func story(name: String) -> Page {
        ...
        let home = homeward.addChoice("Continue to Earth", story: .Home)
